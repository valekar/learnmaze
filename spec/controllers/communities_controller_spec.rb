  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved community as @community" do
        ...
        post :create, {:community => { "name" => "invalid value" }}, valid_session
        assigns(:community).should be_a_new(Community)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested community" do
        ...
        Community.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => community.to_param, :community => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the community as @community" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Community.any_instance.stub(:save).and_return(false)
        put :update, {:id => community.to_param, :community => { "name" => "invalid value" }}, valid_session
        assigns(:community).should eq(community)
      end
